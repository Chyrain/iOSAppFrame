...
#pragma mark - UIImage (HYUtil)
@interface UIImage (HYUtil)

- (CGSize)sizeThatFits:(CGSize)size;

@end

@implementation UIImage (HYUtil)
...
#pragma mark - UIImageView (HYUtil)
@interface UIImageView (HYUtil)
...
#pragma mark - HYPhotoView

@interface HYPhotoView () <UIScrollViewDelegate>
