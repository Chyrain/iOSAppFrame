...
- (void)layoutSubviews {
    ...
    [(UICollectionViewFlowLayout *)_collectionView.collectionViewLayout setItemSize:CGSizeMake([self cellWidth],self.bounds.size.height * CardHeightScale)];
...
- (CGFloat)collectionInset {
    return (self.bounds.size.width/2.0f - [self cellWidth]/2.0f) * 2;
}
